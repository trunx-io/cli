...
describe('tests listing and adding chains', () => {
  test
  .stdout()
  .command(['chains:list', '--configfile', 'trunxtest.json', '--socketName', 'trunxio0'])
  ...
  test
  .stdout()
  .command(['chains:add', '-s', 'https://eos.greymass.com', '--configfile', 'trunxtest.json', '--socketName', 'trunxio0'])
  ...
  test
  .stdout()
  .command(['chains:add', 'https://eos.greymass.com', '--configfile', 'trunxtest.json', '--socketName', 'trunxio0'])
