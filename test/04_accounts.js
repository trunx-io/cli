...
describe('tests listing and adding accounts', () => {
  test
  .stdout()
  .command(['accounts:list', '--configfile', 'trunxtest.json', '--socketName', 'trunxio0'])
  ...
  test
  .stdout()
  .command(['accounts:add', 'eosio', '-c', 'aca376f206b8fc25a6ed44dbdc66547c36c6c33e3a119ffbeaef943642f0e906', '--configfile', 'trunxtest.json', '--socketName', 'trunxio0'])
